...
defineProps({
    offer: Object, // Declaramos que la propiedad es un objeto
});
</script>
...
<template>
    ...
    <div class="max-w-screen-lg mx-auto px-4 pt-5 gap-4">
        ...
        <h2 class="text-2xl font-bold text-gray-800 mt-3">{{ offer.subtitle }}</h2>
        ...
        <div class="flex items-center mt-4 text-gray-600">
            <div>
                <p class="text-sm">Publicado el 
                    <span> 
                        {{ moment(offer.startDate, "YYYY-MM-DD").format("DD MMM,YYYY") }}
                    </span>
                </p>
            </div>
        </div>
        ...
        <div
            ...
            <carousel v-bind="config" :items-to-show="1.5">
                <slide v-for="image in offer.images" :key="image.id">
